...
const WORKITEM_TOOLS = {
  ...
  // Fork-only: upstream's wit_work_item_attachment downloads only. See docs/FORK-ONPREM-PAT.md.
              ...
              text: JSON.stringify(
                {
                  ...
                  url: attachment.url,
                  fileName,
                  hint: "Embed in an HTML field with <img src=\"<url>\"> and set the field format to 'Html' when calling wit_work_item_write. Do not also add an AttachedFile relation if you want the image to appear inline only.",
                },
                null,
                2
              ),
